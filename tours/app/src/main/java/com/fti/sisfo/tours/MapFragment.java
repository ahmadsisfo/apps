...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-0.890513, 100.372849);
    ...
    private void getlinestring() {
        ...
        String get = "&user_id="+pref.getString("personID","");
        final String url  = setting.getString("server_url","http://192.168.1.4/tours/")+"?way=api/index/getlinestring" + get;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try{
                            ...
                            layer.getDefaultLineStringStyle().setColor(0x90BD133D);
                            layer.addLayerToMap();

                            Log.e("error", url);
                            //Toast.makeText(getContext(), response.toString(), Toast.LENGTH_LONG).show();
                        }catch (Exception e){
                            Toast.makeText(getContext(), "pantesan", Toast.LENGTH_LONG).show();
                        }
